...
This requires a headstage or a miniscope that is
...
This requires a computer with sufficient graphics processing capabilities
...
If you want to integrate the Open Ephys Commutator in a way that's alternative to the ways described
above, refer to the :ref:`remote_control` guide to write your own script that writes serial commands
to turn the commutator. If that is insufficient, try consulting the :ref:`dev_guide` or contacting
Open Ephys for help.
